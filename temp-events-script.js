      ...
      eventDetail.innerHTML = `
        ...
        <div class="event-detail-hero">
          ...
          <div class="event-detail-grid">
            ...
            <div class="event-detail-stat"><strong>${escapeHtml(String(totalItems))}</strong><span data-i18n="gearItems">裝備項目</span></div>
          </div>
        </div>
